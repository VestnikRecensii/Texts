...
1. Правило №21. Почему не нужно писать комментарии.

1. Правило №20. Почему нужно писать комментарии.
...
1. Тупые системы именований, когда для разных типов одно и то же действие может выглядеть как len(obj), obj.length, obj.size, obj.size(), obj.length(), \_\_len\_\_(obj) и т.д.
